...
const answer= await inquirer.prompt([               //creating a prompt inquirer type in answer variable
    {                                               //await is used to take and save data from the user
...
let displayResult:number                            //an empty variable is created with datatype number to save & display
